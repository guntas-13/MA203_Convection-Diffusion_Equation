...
plt.xlabel('X')
plt.ylabel('Y')
plt.title('Constant Velocity Field')
plt.axis((0, Lx, 0, Ly))
# plt.savefig("0CV.png")
plt.grid()
plt.show()
...
for i, conc_snapshot in enumerate(Concentration_snapshots):
    if i % 10 == 0:
        ...
        plt.pause(0.000001)
        # if i % 100 == 0:
        #     filename = os.path.join("/Users/guntas13/Desktop/JetBrains Projects/MA203_Project", f'concentration_step_C{i//100:04d}.png')
...
plt.xlabel("X-axis")
plt.ylabel("Y-axis")
plt.title("Intermediate Situation in Constant Velocity Field")
plt.colorbar()
# plt.savefig("3CV.png")
plt.show()
...
plt.xlabel("X-axis")
plt.ylabel("Y-axis")
plt.title("Final Concentration in Constant Velocity Field")
plt.colorbar()
# plt.savefig("4CV.png")
plt.show()